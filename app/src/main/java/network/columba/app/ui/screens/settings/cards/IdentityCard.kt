...
fun IdentityCard(
    ...
    CollapsibleSettingsCard(
        title = stringResource(R.string.my_identity_identity),
        ...
        Text(
            text = stringResource(R.string.identity_card_view_and_share_your_identity_edit),
        ...
        Text(
            text = stringResource(R.string.identity_card_create_and_manage_multiple_identities_for),
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
