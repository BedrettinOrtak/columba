...
fun ThemeSelectionCard(
    ...
    CollapsibleSettingsCard(
        title = stringResource(R.string.theme_selection_card_theme),
        ...
        headerAction = {
            TextButton(onClick = onNavigateToCustomThemes) {
                ...
                Text(stringResource(R.string.theme_management_custom_themes))
            }
        },
    ) {
        // Description
        Text(
            text = stringResource(R.string.theme_selection_card_choose_your_preferred_color_theme_dark),
        ...
        Text(
            text = stringResource(R.string.theme_selection_card_built_in_themes),
                        ...
                        if (selectedTheme == theme) {
                            {
                                Icon(
                                    ...
                                    contentDescription = stringResource(R.string.theme_selection_card_selected),
                                    modifier = Modifier.size(18.dp),
                                )
                            }
                        } else {
                            ...
                            if (selectedTheme == theme) {
                                {
                                    Icon(
                                        imageVector = Icons.Default.Check,
                                        contentDescription = stringResource(R.string.theme_selection_card_selected_91b4),
                                        modifier = Modifier.size(18.dp),
                                    )
                                }
                            } else {
...
fun ThemeColorPreview(theme: AppTheme) {
    ...
    Row(
        ...
        Text(
            text = stringResource(R.string.theme_selection_card_preview),
            style = MaterialTheme.typography.bodySmall,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
        ...
        Text(
            text = if (isDarkTheme) stringResource(R.string.theme_selection_card_dark_mode) else stringResource(R.string.theme_selection_card_light_mode),
            style = MaterialTheme.typography.bodySmall,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
    }
