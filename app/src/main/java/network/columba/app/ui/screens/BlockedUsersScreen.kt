...
fun BlockedUsersScreen(
    ...
    Scaffold(
        ...
        peerToUnblock?.let { peer ->
            val peerLabel = peer.displayName ?: (peer.peerHash.take(16) + "…")
            val unblockedToast = stringResource(R.string.blocked_users_unblocked_toast, peerLabel)
            AlertDialog(
                onDismissRequest = { peerToUnblock = null },
                title = { Text(stringResource(R.string.blocked_users_unblock_title, peerLabel)) },
                text = {
    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(
                    text = stringResource(R.string.blocked_users_blocked_at, dateFormat.format(Date(peer.blockedTimestamp))),
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text(
                        text = stringResource(R.string.blocked_users_blackhole_label),
                        style = MaterialTheme.typography.bodySmall,
                        color =
