...
fun RNodeFlasherCard(
    ...
    CollapsibleSettingsCard(
        title = stringResource(R.string.rnode_flasher_card_rnode_flasher),
        ...
        // Description
        Text(
            text = stringResource(R.string.rnode_flasher_card_flash_or_update_firmware_on_rnode),
        ...
        Text(
            text = stringResource(R.string.rnode_flasher_card_supported_rak4631_heltec_lora32_t_beam),
        ...
        Button(
            ...
            Text(stringResource(R.string.rnode_flasher_card_open_flasher))
        }
    }
}
